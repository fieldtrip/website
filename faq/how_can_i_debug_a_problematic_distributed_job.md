...
Once logged in as other user, you start an interactive MATLAB session and a **[peerslave](/reference/peerslave)** inside it. To ensure that your master will send teh job to this slave, and not to another one in the network, you can use the allowgroup option. 
