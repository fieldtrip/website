...
{% include markup/info %}
In **[ft_prepare_sourcemodel](https://github.com/fieldtrip/fieldtrip/blob/release/ft_prepare_sourcemodel.m)** you can give a **negative** value for cfg.inwardshift to compensate for this rim.
