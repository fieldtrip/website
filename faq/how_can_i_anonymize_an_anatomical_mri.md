...
{% include image src="/static/img/faq/defacevolume2.png" width="400" %}

You can use the standard MATLAB figure rotate button to look at the MRI from different angles.

{% include image src="/static/img/faq/defacevolume1.png" width="400" %}
...
{% include image src="/static/img/faq/defacevolume3.png" width="400" %}
