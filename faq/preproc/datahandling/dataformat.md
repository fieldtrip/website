...
What follows is a summary of the data formats for MEG, EEG and iEEG data, and the auxiliary data files with sensor positions, anatomical MRIs, cortical meshes, volume conduction models, etc.

{% include markup/red %}
We regularly implement support for new data formats. It is therefore likely that this documentation is out of date, so please check the code.
{% include markup/end %}
