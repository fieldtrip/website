...
- [enginecellfun](/reference/engine/enginecellfun)
- [engineexec](/reference/engine/engineexec)
- [enginefeval](/reference/engine/enginefeval)
- [engineget](/reference/engine/engineget)
- [enginepool](/reference/engine/enginepool)

### ... for distributed computing using peer-to-peer

- [peercellfun](/reference/peer/peercellfun)
- [peerfeval](/reference/peer/peerfeval)
- [peerget](/reference/peer/peerget)
- [peercontroller](/reference/peer/peercontroller)
- [peerworker](/reference/peer/peerworker)
- [peerzombie](/reference/peer/peerzombie)
- [peerinfo](/reference/peer/peerinfo)
- [peerlist](/reference/peer/peerlist)
- [peerreset](/reference/peer/peerreset)
