...
{% include image src="/assets/img/example/segmri.jpg" %}
...
{% include image src="/assets/img/example/headmodels/headmodel.png" %}

{% include image src="/assets/img/example/headmodel2.png" %}
