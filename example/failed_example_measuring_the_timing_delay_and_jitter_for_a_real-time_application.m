...
%
% # In a console we start the streaming of the data with acq2ft
%
%
...
% # Now using a different MATLAB session we access the FT buffer on the localhost:
%
%
...
% #  Now, to detect the triggers we have two options: To do flank detection on the fly (by differentiating the trigger channel), or to read the relevant event
%
....
if newsamples>=blocksize
disp('newsamples')
...
% # Both trigger and flank are now recorded on the same channel (here UPTT001). Now we can offline calculate the delays in the online loo
%
%
%
%
