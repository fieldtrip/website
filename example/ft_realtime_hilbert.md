...
The thesis (in Italian) which describes all details and the results is available [here](/static/pdf/example/rt_hilbert/rotonda_thesis_msc.pdf).

The signal analysis details are available [here](/static/pdf/example/gamma_analisys.pdf).
...
{% include image src="/static/img/example/picture_12.png" width="400" %}
