...
{% include image src="/assets/img/example/small_20components_topo2.jpg" width="400" %}
...
{% include image src="/assets/img/example/small_ecgcomponents_compbrowser2.jpg" width="400" %}
...
{% include image src="/assets/img/example/ecgpeaks1.jpg" width="400" %}

{% include image src="/assets/img/example/ecgpeaks2.jpg" width="400" %}
...
{% include image src="/assets/img/example/ecgtimelock_corr.jpg" width="400" %}
{% include image src="/assets/img/example/ecgimagesc.jpg" width="400" %}
...
{% include image src="/assets/img/example/ecgcoherence.jpg" width="400" %}
