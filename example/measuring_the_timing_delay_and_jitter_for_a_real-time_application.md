...
{% include image src="/assets/img/example/sent_and_received_triggers_head_localization_off.jpg" %}
...
{% include image src="/assets/img/example/picture_3.png" %}

This is rather consistent with a uniform distribution between 100-250ms

{% include image src="/assets/img/example/picture_2.png" %}
...
{% include image src="/assets/img/example/delay_hist._1200hz.jpg" %}

We now also plot the sample number of the echo against the sample number of the trigger that preceded i

# Figure 1

{% include image src="/assets/img/example/trigger_smp_vs_echo_smp.jpg" %}
...
{% include image src="/assets/img/example/delay_hist._1200hz_hl_off.jpg" %}
...
{% include image src="/assets/img/example/delay_hist_hl_on_fs_4khz.jpg" %}
...
{% include image src="/assets/img/example/trigger_smp_vs_echo_smp_4khz_read_ev.jpg" %}

This shows no events missing and no accumulative delays.The delay distribution is in Figure 5.

# Figure 

{% include image src="/assets/img/example/delay_hist_hl_on_fs_4khz_detection_read_ev.jpg" %}
...
{% include image src="/assets/img/example/delay_read_header_acq_buffer.jpg" %}
