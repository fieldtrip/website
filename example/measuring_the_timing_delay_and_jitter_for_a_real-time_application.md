...
{{:example:sent_and_received_triggers_head_localization_off.jpg|}}
...
{{:example:delay_hist._1200hz.jpg|}}
...
{{:example:trigger_smp_vs_echo_smp.jpg|}}
...
{{:example:delay_hist._1200hz_hl_off.jpg|}}
...
{{:example:delay_hist_hl_on_fs_4khz.jpg|}}
...
{{:example:trigger_smp_vs_echo_smp_4khz_read_ev.jpg|}}
...
{{:example:delay_hist_hl_on_fs_4khz_detection_read_ev.jpg|}}
...
{{:example:delay_read_header_acq_buffer.jpg|}}
