...
{% include image src="/assets/img/example/time.jpg" %}

{% include image src="/assets/img/example/topos.jpg" width="600" %}

{% include image src="/assets/img/example/fig1.jpg" %}

{% include image src="/assets/img/example/fig2.jpg" %}
