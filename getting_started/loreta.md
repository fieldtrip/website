...
4.  After using loreta2fieldtrip the data is in [FieldTrip volume](https://www.fieldtriptoolbox.org/reference/ft_datatype_volume) format in [MNI space](/faq/how_are_the_different_head_and_mri_coordinate_systems_defined?s[]=mni#details_of_the_mni_coordinate_system).
