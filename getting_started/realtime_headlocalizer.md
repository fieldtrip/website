...
{% include image src="/static/img/getting_started/headloc_flowchart.png" width="600" %}
...
{% include image src="/static/img/getting_started/switch-box-hd15-2-way-bestlink.jpg" %}
