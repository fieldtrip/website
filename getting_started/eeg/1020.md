...
Using FieldTrip, data according to the 10-20, 10-10 or 10-5 system are readily plotted. It is important that the channel labels match the official nomenclature and have the proper capitalization. You can specify the layout that matches your system, e.g.

    cfg.layout = 'EEG1020.lay'
    cfg.layout = 'EEG1010.lay'
    cfg.layout = 'EEG1005.lay'

Examples regarding the type of plots can be observed [here](/tutorial/plotting). If you want to prepare/create your own layout files, please have a look [here](/tutorial/plotting/layout).
