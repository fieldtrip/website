...
You can subsequently epoch your data using [ft_definetrial](/reference/definetrial), and you can read in the data and preprocess it using [ft_preprocessing](/reference/preprocessing). Note that in FieldTrip, no unit conversion takes place.
