...
{% include markup/info %}
This tutorial was written specifically for the [PracticalMEEG 2022 workshop in Aix-en-Provence](/workshop/practicalmeeg2022) in December 2022, and is an adjusted version of the [time-frequency analysis tutorial](/tutorial/timefrequencyanalysis).
{% include markup/end %}
