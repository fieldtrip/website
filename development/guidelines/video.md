...
It can be helpful to prepare a (video) presentation by writing a 'storyboard'. A storyboard can be nothing more than your *text written out per slide* in the *notes* section Powerpoint slides. We found it helpful to collect all the content in this form as it allows easy sharing and correcting as well as providing an [autocue](http://nl.wikipedia.org/wiki/Autocue) when recording a video lecture. 
...
{% include image src="/static/img/development/save_notes.png" width="300" %}
...
{% include image src="/static/img/development/guidelines/zoom_xy.jpg" width="300" %}
...
The are several places and occasions where you might want to do audio or audiovisual recording
...
If you are makeing a recording at your office or at home, you have more flexibilty of the setup. You ca
...
{% include image src="/static/img/development/videosetup1.jpg" width="300" %}
...
{% include image src="/static/img/development/screen_shot_quicktime.png" width="300" %}
...
{% include image src="/static/img/development/guidelines/setting_premiere.png" width="200" %}
...
{% include image src="/static/img/development/guidelines/export_premiere.png" width="300" %}
