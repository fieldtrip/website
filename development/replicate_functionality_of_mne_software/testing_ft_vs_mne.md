...
{% include image src="/assets/img/development/phantom_topoploter.jpg" width="400" %}
...
{% include image src="/assets/img/development/plot_vol_vol_ph.jpg" width="400" %}
### Source space
...
{% include image src="/assets/img/development/ft_plot_mesh_pos.jpg" width="300" %}
...
{% include image src="/assets/img/development/plot_mne1.jpg" width="400" %}

	
	imagesc(reshape(mne1.avg.pow(:,30), 29,29))

{% include image src="/assets/img/development/plot_mne1_2.jpg" width="400" %}
...
{% include image src="/assets/img/development/mne-pinv.png" width="400" %}
{% include image src="/assets/img/development/mne-nopinv.png" width="400" %}
...
{% include image src="/assets/img/development/phantomftvsmne01.png" width="400" %}
...
{% include image src="/assets/img/development/phantomftvsmne02.png" width="400" %}
...
{% include image src="/assets/img/development/plot_source_100.jpg" width="300" %}
...
{% include image src="/assets/img/development/ftplotmesh_ft_phantom.jpg" width="300" %}
...
{% include image src="/assets/img/development/ftplotmesh_ft_phantom_at198.jpg" width="300" %}
...
{% include image src="/assets/img/development/griddiff_mne_ft.jpg" width="450" %}
...
{% include image src="/assets/img/development/replicate_functionality_of_mne_software/plot_source3_100.jpg" width="650" %}

The same figure of a random source calculated with the original leadfield of FieldTrip looks like thi

{% include image src="/assets/img/development/replicate_functionality_of_mne_software/plot_source_100.jpg" width="650" %}
...
{% include image src="/assets/img/development/replicate_functionality_of_mne_software/ftplotmesh_ft_phantom_at284_leadfmne.jpg" width="300" %}
...
{% include image src="/assets/img/development/mne_phantom_browse.png" width="600" %}
...
{% include image src="/assets/img/development/plot_res_sol_100.jpg" width="400" %}
...
{% include image src="/assets/img/development/ftplotmesh_mne_phantom_at284.jpg" width="300" %}
