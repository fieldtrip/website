...
{{:tutorial:sensorygatingparadigm.png?600|}}
...
{{:tutorial:s1s2topography.png?600|}}
...
{{:tutorial:templateheadmodelwithregulargrid.png?600|}}
...
{{:tutorial:atlasbasedtemplategrid.png?|}}
...
{{:tutorial:sourcemodelwarpedinatlasbasedspace.png?|}}
...
{{:tutorial:sourcepowers1parceled.png?|}}
...
{{:tutorial:s1statactvsblparcel.png?|}}
...
{{:tutorial:parceled_nonparceld_stats_s1.png?800|}}
...
{{:tutorial:sourcewaveformsensorygating.png?|600}}
...
{{:tutorial:tfrvirtsensorsensorygating.png?|600}}
...
{{:tutorial:coherencesensorygating.png?|400}}
...
{{:tutorial:imagcoherencesensorygating.png?|400}}
...
{{:tutorial:grangersensorygating.png?|400}}
...
{{:tutorial:grangerflippedsensorygating.png?|}}
