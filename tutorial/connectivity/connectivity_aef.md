...
{% include image src="/assets/img/tutorial/connectivity_aef/figure1.png" width="600" %}
...
To run the following section of code you need the original dataset and trial function: [c,rfhp0.1Hz](https://download.fieldtriptoolbox.org/tutorial/connectivity_aef/c,rfhp0.1Hz), [config](https://download.fieldtriptoolbox.org/tutorial/connectivity_aef/config), and [ft_trialfun_sensorygating.m](https://download.fieldtriptoolbox.org/tutorial/connectivity_aef/ft_trialfun_sensorygating.m)
...
The epoched data can be downloaded [here](https://download.fieldtriptoolbox.org/tutorial/connectivity_aef/dataclean.mat).
...
{% include image src="/assets/img/tutorial/connectivity_aef/figure2.png" width="600" %}
...
{% include image src="/assets/img/tutorial/connectivity_aef/figure3.png" width="600" %}
...
{% include image src="/assets/img/tutorial/connectivity_aef/figure4.png" width="600" %}
...
{% include image src="/assets/img/tutorial/connectivity_aef/figure5.png" width="600" %}
...
{% include image src="/assets/img/tutorial/connectivity_aef/figure7.png" %}
...
{% include image src="/assets/img/tutorial/connectivity_aef/figure8.png" %}
...
{% include image src="/assets/img/tutorial/connectivity_aef/figure9.png" %}
...
{% include image src="/assets/img/tutorial/connectivity_aef/figure10.png" %}
...
{% include image src="/assets/img/tutorial/connectivity_aef/figure11.png" %}
...
{% include image src="/assets/img/tutorial/connectivity_aef/figure12.png" %}
...
{% include image src="/assets/img/tutorial/connectivity_aef/figure13.png" width="800" %}
...
{% include image src="/assets/img/tutorial/connectivity_aef/figure14.png" width="600" %}
...
{% include image src="/assets/img/tutorial/connectivity_aef/figure15.png" width="600" %}
...
{% include image src="/assets/img/tutorial/connectivity_aef/figure16.png" width="400" %}
...
{% include image src="/assets/img/tutorial/connectivity_aef/figure17.png" width="400" %}
...
{% include image src="/assets/img/tutorial/connectivity_aef/figure18.png" width="400" %}
...
{% include image src="/assets/img/tutorial/connectivity_aef/figure19.png" %}
