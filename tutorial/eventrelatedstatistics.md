...
{% include image src="/static/img/development/project/tutorial_stat/ft_stat_tutorial2.png" %}
...
{% include image src="/static/img/tutorial/eventrelatedstatistics/multiplot_ga_fc_fic.png" width="400" %}

{% include image src="/static/img/tutorial/eventrelatedstatistics/singleplotMLT12_ga_fc_fic.png" width="400" %}
...
{% include image src="/static/img/tutorial/eventrelatedstatistics/erfstats-allsubj-indiv.png" width="400" %}
...
{% include image src="/static/img/tutorial/eventrelatedstatistics/mlt12_300to700ms_allsubj_fc_fic.png" width="400" %}
...
{% include image src="/static/img/tutorial/eventrelatedstatistics/depttestmatlab_nomcc.png" width="200" %}
...
{% include image src="/static/img/tutorial/eventrelatedstatistics/depttest_nonpara_fieldtrip_nomcc.png" width="200" %}
...
{% include image src="/static/img/tutorial/eventrelatedstatistics/depttest_nonpara_fieldtrip_cluster2.png" width="200" %}
...
{% include image src="/static/img/tutorial/eventrelatedstatistics/depttest_nonpara_fieldtrip_cluster_fig1.png" width="400" %}

{% include image src="/static/img/tutorial/eventrelatedstatistics/depttest_nonpara_fieldtrip_cluster_fig2.png" width="400" %}

{% include image src="/static/img/tutorial/eventrelatedstatistics/depttest_nonpara_fieldtrip_cluster_fig3.png" width="400" %}

{% include image src="/static/img/tutorial/eventrelatedstatistics/depttest_nonpara_fieldtrip_cluster_fig4.png" width="400" %}
