...
In this tutorial, we will show how to compute the ongoing phase and power of the LFP at the time of neuronal firing, and statistics of spike-LFP phase-coupling, such as the Rayleigh probability or the PPC (Vinck et al., 2010, NeuroImage, 2011, J Comp Neurosci). To this end, we will
...
{% include image src="/assets/img/tutorial/tutorialfieldtrip2.png" %}
...
{% include image src="/assets/img/tutorial/flowchartspikelfp02.png" %}
...
{% include image src="/assets/img/tutorial/tssamp.png" %}
...
{% include image src="/assets/img/tutorial/spiketriggeredinterpolation.png" %}
...
{% include image src="/assets/img/tutorial/sta_post.png" %}
...
{% include image src="/assets/img/tutorial/sta_pre.png" %}
...
{% include image src="/assets/img/tutorial/ppcavgsig002a_wf.png" %}
...
{% include image src="/assets/img/tutorial/ppctfr_example_sig002a_wf.png" width="300" %}

Running the same script but now replacing param = 'ppc0' with 'param = plv' gives the following figur

{% include image src="/assets/img/tutorial/plvtfr_example_sig002a_wf.png" width="300" %}
