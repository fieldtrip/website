...
{% include image src="/static/img/tutorial/tutorialfieldtrip2.png" %}
...
{% include image src="/static/img/tutorial/flowchartspikelfp02.png" %}
...
{% include image src="/static/img/tutorial/tssamp.png" %}
...
{% include image src="/static/img/tutorial/spiketriggeredinterpolation.png" %}
...
{% include image src="/static/img/tutorial/sta_post.png" %}
...
{% include image src="/static/img/tutorial/sta_pre.png" %}
...
{% include image src="/static/img/tutorial/ppcavgsig002a_wf.png" %}
...
{% include image src="/static/img/tutorial/ppctfr_example_sig002a_wf.png" width="300" %}

Running the same script but now replacing param = 'ppc0' with 'param = plv' gives the following figur

{% include image src="/static/img/tutorial/plvtfr_example_sig002a_wf.png" width="300" %}
