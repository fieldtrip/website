...
{{:tutorial:tutorialfieldtrip2.png|}}
...
{{:tutorial:flowchartspikelfp02.png|}}
...
{{:tutorial:spiketriggeredinterpolation.png|}}
...
{{:tutorial:ppctfr_example_sig002a_wf.png?direct&300|}}

Running the same script but now replacing param = 'ppc0' with 'param = plv' gives the following figur

{{:tutorial:plvtfr_example_sig002a_wf.png?direct&300|}}
