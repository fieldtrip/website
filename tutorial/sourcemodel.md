...
{% include image src="/assets/img/tutorial/minimumnormestimate/filled01new.png" width="550" %}
...
{% include image src="/assets/img/tutorial/minimumnormestimate/sspace01new.png" width="450" %}
...
{% include image src="/assets/img/example/mnispace/brains.gif" width="500" %}--" %}

**Figure 1a: Example: the MNI template brain and the brains of 3 subjects**

{% include image src="/assets/img/example/mnispace/mni_grids2.gif" width="500" %}--" %}
...
{% include image src="/assets/img/example/mnispace/mni_fig1a.png" width="300" %}
...
{% include image src="/assets/img/example/mnispace/mni_fig2b.png" width="300" %}
