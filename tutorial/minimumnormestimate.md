...
{{:development:replicate_functionality_of_mne_software:pipeline_mne.png?550|Figure 1. An overview of the bigger steps in the calculation of the minimum-norm estimate}}
