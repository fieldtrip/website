...
{% include image src="/assets/img/tutorial/automatic_artifact_rejection/negative_trlpadding.png" %}
...
If you call ft_artifact_zvalue with cfg as _output_ (''cfg = ft_artifact_zvalue(cfg)''), you can directly feed that output into ft_rejectartifact. Examples of this will be given below.
