...
{% include image src="/static/img/tutorial/overview_artifact_detection.png" width="600" %}
...
{% include image src="/static/img/tutorial/eq1.png" width="120" %}

where

{% include image src="/static/img/tutorial/eq2.png" width="120" %}
{% include image src="/static/img/tutorial/eq3.png" width="150" %}
...
{% include image src="/static/img/tutorial/eq4.png" width="120" %}
...
{% include image src="/static/img/tutorial/zthreshold.png" %}
...
{% include image src="/static/img/tutorial/artpadding.png" %}
...
{% include image src="/static/img/tutorial/trlpadding.png" width="600" %}
...
{% include image src="/static/img/tutorial/fltpadding.png" width="600" %}
...
{% include image src="/static/img/tutorial/bothpadding.png" %}
...
{% include image src="/static/img/tutorial/negative_trlpadding.png" %}
...
{% include image src="/static/img/tutorial/artifactjump.png" width="600" %}
...
{% include image src="/static/img/tutorial/artifactjump2.png" width="600" %}
...
{% include image src="/static/img/tutorial/artifactmuscle.png" width="600" %}
...
{% include image src="/static/img/tutorial/artifacteog.png" width="600" %}
