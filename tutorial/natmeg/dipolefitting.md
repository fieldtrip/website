...
We start with the anatomical MRI data, which comes directly from the scanner in DICOM format. You can download the [dicom.zip](ftp://ftp.fieldtriptoolbox.org/pub/fieldtrip/tutorial/natmeg/dicom.zip) from our ftp server. We suggest that you unzip the dicom files in a separate directory.
...
{% include image src="/assets/img/tutorial/natmeg/dipolefitting/natmeg_dip_geometry1.png" width="500" %}
...
{% include image src="/assets/img/tutorial/natmeg/dipolefitting/natmeg_dip_mri_orig.png" width="500" %}--" %}
...
{% include image src="/assets/img/tutorial/natmeg/dipolefitting/natmeg_dip_mri_resliced.png" width="500" %}--" %}
...
{% include image src="/assets/img/tutorial/natmeg/dipolefitting/natmeg_dip_segmented_brain.png" width="400" %}

{% include image src="/assets/img/tutorial/natmeg/dipolefitting/natmeg_dip_segmented_skull.png" width="400" %}

{% include image src="/assets/img/tutorial/natmeg/dipolefitting/natmeg_dip_segmented_scalp.png" width="400" %}
...
{% include image src="/assets/img/tutorial/natmeg/dipolefitting/natmeg_dip_scalp.png" width="400" %}--" %}
...
{% include image src="/assets/img/tutorial/natmeg/dipolefitting/natmeg_dip_highres_scalp.png" width="400" %}--" %}
...
{% include image src="/assets/img/tutorial/natmeg/dipolefitting/natmeg_dip_geometry2.png" width="500" %}--" %}

### Process the MEG data

The processing of the MEG dataset is done similar to the [Preprocessing and event-related activity in MEG and EEG data](/tutorial/natmeg/preprocessing) tutorial. It requires the custom trial function [trialfun_oddball_stimlocked.m](ftp://ftp.fieldtriptoolbox.org/pub/fieldtrip/tutorial/natmeg/trialfun_oddball_stimlocked.m) to be on your MATLAB path.
...
{% include image src="/assets/img/tutorial/natmeg/dipolefitting/natmeg_dip_meg_multiplot.png" width="600" %}--" %}
...
{% include image src="/assets/img/tutorial/natmeg/dipolefitting/natmeg_dip_planarortho.png" width="400" %}--" %}
...
{% include image src="/assets/img/tutorial/natmeg/dipolefitting/natmeg_dip_symx.png" width="400" %}--" %}
...
{% include image src="/assets/img/tutorial/natmeg/dipolefitting/natmeg_dip_nosym.png" width="400" %}--" %}
...
{% include image src="/assets/img/tutorial/natmeg/dipolefitting/natmeg_dip_timeseries.png" width="500" %}--" %}
...
{% include image src="/assets/img/tutorial/natmeg/dipolefitting/natmeg_dip_sourcedif.png" width="400" %}--" %}
...
{% include image src="/assets/img/tutorial/natmeg/dipolefitting/natmeg_dip_moving.png" width="400" %}--" %}
...
{% include image src="/assets/img/tutorial/natmeg/dipolefitting/natmeg_dip_meshorig.png" width="400" %}--" %}
...
{% include image src="/assets/img/tutorial/natmeg/dipolefitting/natmeg_dip_meshinfl.png" width="400" %}--" %}
...
{% include image src="/assets/img/tutorial/natmeg/dipolefitting/natmeg_dip_segorg.png" width="200" %}

*The original segmentation *

{% include image src="/assets/img/tutorial/natmeg/dipolefitting/natmeg_dip_segdil1.png" width="200" %}

*After dilation of 1 voxel *

{% include image src="/assets/img/tutorial/natmeg/dipolefitting/natmeg_dip_segdil2.png" width="200" %}

*After dilation of 2 voxels *

{% include image src="/assets/img/tutorial/natmeg/dipolefitting/natmeg_dip_segbool.png" width="200" %}
...
{% include image src="/assets/img/tutorial/natmeg/dipolefitting/natmeg_dip_sourceeeg_symx.png" width="400" %}--" %}
