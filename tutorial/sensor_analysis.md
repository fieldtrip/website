...
{{:tutorial:sensor_analysis:design.png|Figure 1: illustration of the experimental paradigm.}}
...
{{:tutorial:sensor_analysis:multipletrials.png?600|Figure 1a: Some example trials, with time t=0 marked.}}
...
{{:tutorial:sensor_analysis:multiploter.png?600|Figure 2: event-related field for each MEG sensor.}}
...
{{:tutorial:sensor_analysis:multiploter_interactive.png?300|Figure 3: click the box to show the average of the selected sensors.}}
...
{{:tutorial:sensor_analysis:singleploter.png?300|Figure 4: average ERF for some left posterior sensors.}}
...
{{:tutorial:sensor_analysis:topoploter.png|Figure 5: topographical representation of the ERF deflection around 300ms after visual stimulus onset.}}
...
{{tutorial:timefrequencyanalysis:tfrtiles.png?600|Figure 6: Time and frequency smoothing. (a) For a fixed length time window the time and frequency smoothing remains fixed. (b) For time windows that decrease with frequency, the temporal smoothing decreases and the frequency smoothing increases.}}
...
{{:tutorial:sensor_analysis:multiplottfr.png?600|Figure 7: Time-frequency representation using a Hanning taper with a fixed window length.}}
...
{{ :tutorial:figurepipeline.png?600 |}}
...
{{ :tutorial:sensor_analysis:analysispipeline_sensor_analysis.png?600 |}}
...
{{:tutorial:sensor_analysis:cmc.png|Figure 8: results of sensor-level analysis of corticomuscular coherence. Reference channel was the left EMG.}}
