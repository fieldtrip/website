...
The goal of the plotting functions in FieldTrip is to ease the visualization of complex data structures with multiple dimensions and with data that is not trivial to interpret spatially. This is accomplished with high-level functions (e.g. **[/reference/ft_topoplotER](/reference/ft_topoplotER)** or **[/reference/ft_multiplotTFR](/reference/ft_multiplotTFR)**) and low-level functions (with prefixes 'ft_plot_' and 'ft_select_', e.g. ft_plot_matrix or ft_select_box). For more simple data, such as a set of reaction times of the subject, we expect you to use the standard MATLAB plotting functions.
...
{% include image src="/static/img/tutorial/plotting/2017/fig1.png" %}
...
{% include image src="/static/img/tutorial/plotting/2017/fig2.png" %}
...
{% include image src="/static/img/tutorial/plotting/2017/fig3.png" %}
...
{% include image src="/static/img/tutorial/plotting/2017/fig4.png" %}
...
{% include image src="/static/img/tutorial/plotting/2017/fig5.png" %}
...
{% include image src="/static/img/tutorial/plotting/2017/fig6.png" %}
...
{% include image src="/static/img/tutorial/plotting/2017/fig7.png" %}
...
{% include image src="/static/img/tutorial/plotting/2017/fig8.png" %}
...
{% include image src="/static/img/tutorial/plotting/2017/fig9.png" %}
...
{% include image src="/static/img/tutorial/plotting/2017/fig10.png" %}
...
{% include image src="/static/img/tutorial/plotting/2017/fig11.png" %}
...
{% include image src="/static/img/tutorial/plotting/2017/fig12.png" %}
...
{% include image src="/static/img/tutorial/plotting/2017/fig13.png" %}
...
{% include image src="/static/img/tutorial/plotting/2017/fig14.png" %}
...
{% include image src="/static/img/tutorial/plotting/2017/fig15.png" %}
...
{% include image src="/static/img/tutorial/plotting/2017/fig16.png" %}
...
{% include image src="/static/img/tutorial/plotting/2017/fig17.png" %}
...
{% include image src="/static/img/tutorial/plotting/2017/fig18.png" %}
...
{% include image src="/static/img/tutorial/plotting/2017/fig19.png" %}

See http://colorbrewer2.org for more details.

In the help of **[/reference/ft_topoplotER](/reference/ft_topoplotER)** and **[/reference/ft_topoplotTFR](/reference/ft_topoplotTFR)** you can find many cfg options. For instance by specifying the cfg.xlim as a vector the functions makes selections of multiple time-windows and plots them as a series of subplots.
...
{% include image src="/static/img/tutorial/plotting/2017/fig20.png" %}
...
{% include image src="/static/img/tutorial/plotting/2017/fig21.png" %}
...
{% include image src="/static/img/tutorial/plotting/2017/fig22.png" %}
...
{% include image src="/static/img/tutorial/plotting/2017/fig23.png" %}
...
{% include image src="/static/img/tutorial/plotting/2017/fig24.png" %}
...
{% include image src="/static/img/tutorial/plotting/2017/fig25.png" %}
{% include image src="/static/img/tutorial/plotting/2017/fig26.png" %}
{% include image src="/static/img/tutorial/plotting/2017/fig27.png" %}
{% include image src="/static/img/tutorial/plotting/2017/fig28.png" %}
...
{% include image src="/static/img/tutorial/plotting/2017/fig29.png" %}

### Plotting channel-level connectivity

This is possible using **[/reference/ft_connectivityplot](/reference/ft_connectivityplot)**, **[/reference/ft_multiplotCC](/reference/ft_multiplotCC)** and **[/reference/ft_topoplotCC](/reference/ft_topoplotCC)**.

###  Plotting Principal or Independent Components (PCA/ICA)

To plot PCA, ICA or other decompositions that result from **[/reference/ft_componentanalysis](/reference/ft_componentanalysis)** you can use ft_topoplotIC for the topographies and ft_databrowser for the topographies combined with the time series. For a viewer that displays the power spectrum, topography and variance over time of each component, see [https://github.com/fieldtrip/fieldtrip/blob/master/contrib/misc/ft_icabrowser.m](https://github.com/fieldtrip/fieldtrip/blob/master/contrib/misc/ft_icabrowser.m).
...
{% include image src="/static/img/tutorial/plotting/2017/fig30.png" %}

    % idem, in MNI (or SPM) coordinates
    ft_sourceplot(cfg, sourceDiffIntNorm);

{% include image src="/static/img/tutorial/plotting/2017/fig31.png" %}
...
{% include image src="/static/img/tutorial/plotting/2017/fig32.png" %}

    % idem, in MNI (or SPM) coordinates
    ft_sourceplot(cfg, sourceDiffIntNorm);

{% include image src="/static/img/tutorial/plotting/2017/fig33.png" %}
...
{% include image src="/static/img/tutorial/plotting/2017/fig34.png" %}
...
{% include image src="/static/img/tutorial/plotting/2017/fig35.png" %}

    ft_sourceplot(cfg, sourceDiffIntNorm);
    colormap hot

{% include image src="/static/img/tutorial/plotting/2017/fig36.png" %}

    ft_sourceplot(cfg, sourceDiffIntNorm);
    colormap cool

{% include image src="/static/img/tutorial/plotting/2017/fig37.png" %}

If you right-click with the mouse on the colorbar in the figure, you can also do this interactively.

To  interactively explore higher-dimensional data (such as TFR data) on the surface, **[/reference/ft_sourceplot](/reference/ft_sourceplot)** cannot be used. You can make selections of a specific time and/or frequency and make a series of sublplots.
