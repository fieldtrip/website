...
{% include image src="/static/img/tutorial/artifactdetect/untitled.jpg" %}

Trial 84 shows an artifact which is caused by the electronics. Notice the jump in sensor MLT4

{% include image src="/static/img/tutorial/artifactdetect/untitled-1.jpg" width="530" %}
...
{% include image src="/static/img/tutorial/artifactdetect/untitled-2.jpg" %}
...
{% include image src="/static/img/tutorial/artifactdetect/channel_trialvariance.png" width="650" %}
...
{% include image src="/static/img/tutorial/artifactdetect/channel_trialvariance2.png" width="650" %}
...
{% include image src="/static/img/tutorial/fig4.png" width="600" %}
